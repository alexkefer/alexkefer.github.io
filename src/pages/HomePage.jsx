    ...
    <div className={"flex flex-col gap-6"}>
      ...
      <div className={"full-width-text-box"}>
        ...
        <p>
          ...
          to game development. I am always looking for new projects to work on
          and new technologies to learn.
        </p>
        <div className={"flex"}>
      ...
      <div className={"full-width-text-box"}>
        ...
        <p>
          I am always open to new opportunities and connections. Feel free to
          reach out to me.
        </p>
        <div className={"flex"}>
